          ...
          >
            ...
            >
              <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
                <rect width="36" height="36" rx="18" fill="#F6F6F6" fill-opacity="0.1"/>
                <path d="M18.0002 21.3333L13.8335 17.1666L15.0002 15.9583L17.1668 18.125V11.3333H18.8335V18.125L21.0002 15.9583L22.1668 17.1666L18.0002 21.3333ZM13.0002 24.6666C12.5418 24.6666 12.1495 24.5035 11.8231 24.1771C11.4967 23.8507 11.3335 23.4583 11.3335 23V20.5H13.0002V23H23.0002V20.5H24.6668V23C24.6668 23.4583 24.5036 23.8507 24.1772 24.1771C23.8509 24.5035 23.4585 24.6666 23.0002 24.6666H13.0002Z" fill="white"/>
              </svg>
            </button>
          </div>
