  ...
  return (
    <div className="veda-auth-root">
        ...
        <div className="veda-auth-brand">
          ...
          <div className="veda-auth-brand__copy">
            <h1 className="veda-auth-brand__headline">
              Join thousands<br />of teachers<br />
              <span className="veda-auth-brand__accent">saving hours.</span>
            </h1>
            <p className="veda-auth-brand__sub">
              Create your free VedaAI account and start generating beautiful, AI-crafted question papers tailored to your curriculum.
            </p>
          </div>
          <div className="veda-auth-brand__chips">
            {["Free to Start", "No Credit Card", "AI-Powered"].map((chip) => (
      ...
      <style>{`
        ...
        .veda-auth-brand__logo { display: flex; align-items: center; gap: 12px; }
        .veda-auth-brand__wordmark {
          font-family: var(--font-bricolage), sans-serif;
          font-size: 28px; font-weight: 800; color: #fff; letter-spacing: -0.04em;
        }
        ...
        .veda-auth-brand__sub {
          ...
          color: rgba(255,255,255,0.55); margin: 0; max-width: 420px;
        }
        .veda-auth-brand__chips { display: flex; flex-wrap: wrap; gap: 10px; }
        .veda-auth-brand__chip {
          padding: 6px 14px; border-radius: 100px;
          border: 1px solid rgba(255,255,255,0.15);
          font-size: 13px; font-weight: 500; color: rgba(255,255,255,0.65);
          background: rgba(255,255,255,0.05); letter-spacing: -0.01em;
        }
        .veda-auth-form-wrap { flex-shrink: 0; width: 420px; }
        ...
        .veda-clerk-card {
          ...
          padding: 40px 32px !important; color: #fff !important;
        }
        .veda-clerk-header-title {
          color: #fff !important;
          font-family: var(--font-bricolage), sans-serif !important;
          font-size: 24px !important; font-weight: 700 !important; letter-spacing: -0.04em !important;
        }
        .veda-clerk-header-subtitle { color: rgba(255,255,255,0.5) !important; font-size: 14px !important; }
        .veda-clerk-btn-primary {
          background: linear-gradient(135deg, #ff7243, #c93d08) !important;
          border: none !important; border-radius: 12px !important;
          font-weight: 600 !important; font-size: 15px !important; height: 48px !important;
        ...
        .veda-clerk-input {
          ...
          border-radius: 10px !important; color: #fff !important; height: 44px !important;
        }
